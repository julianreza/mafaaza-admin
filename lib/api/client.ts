...
export function Environment(name: string): BaseURL {
    return `https://${name}-mafaaza-api-svs2.encr.app`
}
...
/**
 * Client is an API client for the mafaaza-api-svs2 Encore application.
 */
...
export namespace auth {
    export interface AuthParams {
        /**
         * Present for API clients using the bearer plugin.
         */
        authorization?: string

        /**
         * Present for browser clients using the session cookie.
         */
        cookie?: string
    }
    ...
    export class ServiceClient {
        ...
        /**
         * Every Better Auth route — sign-up, sign-in, sign-out, get-session, OAuth
         * callbacks — is served from this single catch-all. Adding a Better Auth plugin
         * later exposes its routes here automatically with no extra wiring.
         * 
         * These are raw endpoints, so they are intentionally outside Encore's typed
         * contract: no declarative validation, and they do not appear in the generated
         * client or OpenAPI spec. Better Auth owns the request/response shapes.
         */
...
export namespace mafaaza_api {
    ...
    export class ServiceClient {
        ...
        /**
         * Liveness probe. The API gateway and auth handler are defined in the auth service,
         * so nothing needs to be imported across a service boundary here.
         */
        public async ping(): Promise<PingResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/ping`)
            return await resp.json() as PingResponse
        }

        /**
         * A protected endpoint in a different service from the auth handler.
         * 
         * Encore runs the auth handler before this executes, so `getAuthData()` is
         * guaranteed non-null here — no token or session object has to be threaded across
         * the service boundary by hand.
         */
...
export namespace masters {
    export interface CreateOrderItemInput {
        ...
        quantity: number
        /**
         * Override price — defaults to product.price if omitted
         */
        unitPrice?: number
    }
    ...
    export interface ListOrdersRequest {
        ...
        /**
         * ISO date string — lower bound on createdAt (inclusive)
         */
        dateFrom?: string

        /**
         * ISO date string — upper bound on createdAt (inclusive)
         */
        dateTo?: string
    }
    ...
    export class ServiceClient {
        ...
        public async createOrder(params: CreateOrderRequest): Promise<CreateOrderResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/orders`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "mafaaza-api-svs2-Generated-TS-Client (Encore/v1.57.13)";
        }
